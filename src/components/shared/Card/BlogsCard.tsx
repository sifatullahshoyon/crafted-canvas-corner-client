  ...
  return (
    <Card className="relative group max-w-[305px] border-none  p-4">
      ...
      <CardContent className="text-center mt-4">
        ...
        <RatingStart />
        <div
          className="bg-[#1A1A1A] hover:bg-[#1A1A1A] text-white w-full py-4  rounded-md mt-3 absolute bottom-0 left-1/2 flex gap-2 -translate-x-1/2 -translate-y-1/2 opacity-0 
